              ...
              <Table className="w-full ">
                ...
                <TableBody>
                  ...
                  <TableRow className="border-0">
                    <TableCell />
                    <TableCell>Total Items Price</TableCell>
                    <TableCell>{order.itemsPrice}</TableCell>
                  </TableRow>
                  <TableRow className="border-0">
                    <TableCell />
                    <TableCell>Tax Price</TableCell>
                ...
                <ScrollArea className="whitespace-nowrap pb-5">
                  {addresses.length ? (
                    <p className="my-4 font-medium">
                      Select any of below or create new Address
                    </p>
                  ) : (
                    ""
                  )}
                  ...
                  >
                    {addresses.map((address) => (
                      <div
                        className={clsx(
                          "min-w-[290px] cursor-pointer border-2 border-transparents transition-all rounded-md",
    ...
    <CardContent>
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-700">
          ...
          {order.paidAt
            ? humaniseDateObject(new Date(order.paidAt))
            : "Not Paid"}
        </p>
      </div>
    </CardContent>
